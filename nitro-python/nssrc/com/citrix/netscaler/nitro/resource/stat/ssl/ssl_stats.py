...
class ssl_stats(base_resource) :
	def __init__(self) :
		...
		self._ssltotrsa3072keyexchanges = 0
		self._sslrsa3072keyexchangesrate = 0
		...
		self._sslbetotrsa3072keyexchanges = 0
		self._sslbersa3072keyexchangesrate = 0
	...
	@property
	def sslbersa3072keyexchangesrate(self) :
		r"""Rate (/s) counter for sslbetotrsa3072keyexchanges.
		"""
		try :
			return self._sslbersa3072keyexchangesrate
		except Exception as e:
			raise e
	...
	@property
	def sslbetotrsa3072keyexchanges(self) :
		r"""Number of back-end RSA 3072-bit key exchanges on the Citrix ADC.
		"""
		try :
			return self._sslbetotrsa3072keyexchanges
		except Exception as e:
			raise e
	...
	@property
	def sslrsa3072keyexchangesrate(self) :
		r"""Rate (/s) counter for ssltotrsa3072keyexchanges.
		"""
		try :
			return self._sslrsa3072keyexchangesrate
		except Exception as e:
			raise e
	...
	@property
	def ssltotrsa3072keyexchanges(self) :
		r"""Number of RSA 3072-bit key exchanges on the Citrix ADC.
		"""
		try :
			return self._ssltotrsa3072keyexchanges
		except Exception as e:
			raise e
