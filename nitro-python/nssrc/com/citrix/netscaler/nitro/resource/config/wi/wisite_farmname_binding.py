...
class wisite_farmname_binding(base_resource) :
	...
	def filter_add_parameters(cls, resource) :
		...
		"""
		addresource = wisite_farmname_binding()
		addresource.sitepath = resource.sitepath
		addresource.farmname = resource.farmname
		addresource.xmlserveraddresses = resource.xmlserveraddresses
		addresource.groups = resource.groups
		addresource.recoveryfarm = resource.recoveryfarm
		addresource.xmlport = resource.xmlport
		addresource.transport = resource.transport
		addresource.sslrelayport = resource.sslrelayport
		addresource.loadbalance = resource.loadbalance
		return addresource
