...
class nsip(base_resource) :
	...
	def __init__(self) :
		...
		self._iptype = None
		self._operationalarpowner = None
		self.___count = None
	...
	@property
	def arpowner(self) :
		r"""The arp owner in a Cluster for this IP address. It can vary from 0 to 31.<br/>Default value: 255.
		"""
		try :
			return self._arpowner
		except Exception as e:
			raise e

	@arpowner.setter
	def arpowner(self, arpowner) :
		r"""The arp owner in a Cluster for this IP address. It can vary from 0 to 31.<br/>Default value: 255
		"""
		try :
			self._arpowner = arpowner
		except Exception as e:
			raise e
	...
	@property
	def operationalarpowner(self) :
		r"""Run time operational Arp Owner.
		"""
		try :
			return self._operationalarpowner
		except Exception as e:
			raise e
	...
	def filter_add_parameters(cls, resource) :
		...
		addresource.arpowner = resource.arpowner
		return addresource
	...
	def filter_update_parameters(cls, resource) :
		...
		updateresource.arpowner = resource.arpowner
