...
class appfwprofile_creditcardnumber_binding(base_resource) :
	...
	def filter_add_parameters(cls, resource) :
		...
		"""
		addresource = appfwprofile_creditcardnumber_binding()
		addresource.name = resource.name
		addresource.comment = resource.comment
		addresource.state = resource.state
		addresource.creditcardnumber = resource.creditcardnumber
		addresource.creditcardnumberurl = resource.creditcardnumberurl
