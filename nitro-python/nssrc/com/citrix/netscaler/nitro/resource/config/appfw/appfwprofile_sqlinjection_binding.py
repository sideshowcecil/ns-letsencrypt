...
class appfwprofile_sqlinjection_binding(base_resource) :
	...
	def filter_add_parameters(cls, resource) :
		...
		"""
		addresource = appfwprofile_sqlinjection_binding()
		addresource.name = resource.name
		addresource.sqlinjection = resource.sqlinjection
		addresource.formactionurl_sql = resource.formactionurl_sql
		addresource.isregex_sql = resource.isregex_sql
		addresource.as_scan_location_sql = resource.as_scan_location_sql
		addresource.as_value_type_sql = resource.as_value_type_sql
		addresource.as_value_expr_sql = resource.as_value_expr_sql
		addresource.isvalueregex_sql = resource.isvalueregex_sql
