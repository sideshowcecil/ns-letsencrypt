...
class wisite_translationinternalip_binding(base_resource) :
	...
	def filter_add_parameters(cls, resource) :
		...
		"""
		addresource = wisite_translationinternalip_binding()
		addresource.sitepath = resource.sitepath
		addresource.translationinternalip = resource.translationinternalip
		addresource.translationinternalport = resource.translationinternalport
		addresource.translationexternalip = resource.translationexternalip
		addresource.translationexternalport = resource.translationexternalport
		addresource.accesstype = resource.accesstype
		return addresource
