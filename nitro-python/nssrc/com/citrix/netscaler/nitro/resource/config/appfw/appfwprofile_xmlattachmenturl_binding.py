...
class appfwprofile_xmlattachmenturl_binding(base_resource) :
	...
	def filter_add_parameters(cls, resource) :
		...
		"""
		addresource = appfwprofile_xmlattachmenturl_binding()
		addresource.name = resource.name
		addresource.comment = resource.comment
		addresource.state = resource.state
		addresource.xmlattachmenturl = resource.xmlattachmenturl
		addresource.xmlmaxattachmentsizecheck = resource.xmlmaxattachmentsizecheck
		addresource.xmlmaxattachmentsize = resource.xmlmaxattachmentsize
		addresource.xmlattachmentcontenttypecheck = resource.xmlattachmentcontenttypecheck
		addresource.xmlattachmentcontenttype = resource.xmlattachmentcontenttype
