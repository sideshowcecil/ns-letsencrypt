...
class Interface(base_resource) :
	...
	@property
	def ringsize(self) :
		r"""The receive ringsize of the interface. A higher number provides more number of buffers in handling incoming traffic.<br/>Default value: 2048<br/>Minimum length =  512<br/>Maximum length =  16384.
		"""
		try :
	...
	@property
	def ringtype(self) :
		r"""The receive ringtype of the interface (Fixed or Elastic). A fixed ring type pre-allocates configured number of buffers irrespective of traffic rate. In contrast, an elastic ring, expands and shrinks based on incoming traffic rate.<br/>Default value: Elastic<br/>Possible values = Elastic, Fixed.
		"""
		try :
	...
	@property
	def actualringsize(self) :
		r"""Actual receive ringsize of the interface. This will be same as configured receive ringsize when ringtype is Fixed whereas it denotes the current number of receive buffers allocated when ringtype is Elastic.
		"""
		try :
			return self._actualringsize
		except Exception as e:
			raise e
	...
	def filter_update_parameters(cls, resource) :
		...
		updateresource.ringsize = resource.ringsize
		updateresource.ringtype = resource.ringtype
