...
class appfwprofile_xmlxss_binding(base_resource) :
	...
	def filter_add_parameters(cls, resource) :
		...
		"""
		addresource = appfwprofile_xmlxss_binding()
		addresource.name = resource.name
		addresource.comment = resource.comment
		addresource.state = resource.state
		addresource.xmlxss = resource.xmlxss
		addresource.isregex_xmlxss = resource.isregex_xmlxss
		addresource.as_scan_location_xmlxss = resource.as_scan_location_xmlxss
