...
class sslcipher_sslciphersuite_binding(base_resource) :
	...
	def filter_add_parameters(cls, resource) :
		...
		"""
		addresource = sslcipher_sslciphersuite_binding()
		addresource.ciphergroupname = resource.ciphergroupname
		addresource.cipheroperation = resource.cipheroperation
		addresource.ciphgrpals = resource.ciphgrpals
		addresource.ciphername = resource.ciphername
		addresource.cipherpriority = resource.cipherpriority
		return addresource
