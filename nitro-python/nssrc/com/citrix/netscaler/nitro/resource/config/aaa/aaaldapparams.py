...
class aaaldapparams(base_resource) :
	...
	@property
	def sectype(self) :
		r"""Type of security used for communications between the Citrix ADC and the LDAP server. For the PLAINTEXT setting, no encryption is required.<br/>Default value: TLS<br/>Possible values = PLAINTEXT, TLS, SSL.
		"""
		try :
