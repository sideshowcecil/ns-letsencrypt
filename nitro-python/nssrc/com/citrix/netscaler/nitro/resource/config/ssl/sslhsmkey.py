...
class sslhsmkey(base_resource) :
	...
	@property
	def key(self) :
		r"""Name of the key. optionally, for Thales, path to the HSM key file; /var/opt/nfast/kmdata/local/ is the default path. Applies when HSMTYPE is THALES or KEYVAULT.<br/>Maximum length =  63.
		"""
		try :
			return self._key
		except Exception as e:
