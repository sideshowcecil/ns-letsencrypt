...
class appfwprofile_xmlvalidationurl_binding(base_resource) :
	...
	def filter_add_parameters(cls, resource) :
		...
		"""
		addresource = appfwprofile_xmlvalidationurl_binding()
		addresource.name = resource.name
		addresource.comment = resource.comment
		addresource.state = resource.state
		addresource.xmlvalidationurl = resource.xmlvalidationurl
		addresource.xmlrequestschema = resource.xmlrequestschema
		addresource.xmlresponseschema = resource.xmlresponseschema
		addresource.xmlwsdl = resource.xmlwsdl
		addresource.xmladditionalsoapheaders = resource.xmladditionalsoapheaders
		addresource.xmlendpointcheck = resource.xmlendpointcheck
		addresource.xmlvalidatesoapenvelope = resource.xmlvalidatesoapenvelope
		addresource.xmlvalidateresponse = resource.xmlvalidateresponse
