...
class appfwprofile_binding(base_resource):
	...
	@property
	def appfwprofile_jsonxssurl_bindings(self) :
		r"""jsonxssurl that can be bound to appfwprofile.
		"""
		try :
			return self._appfwprofile_jsonxssurl_binding
		except Exception as e:
			raise e
	...
	@property
	def appfwprofile_fileuploadtype_bindings(self) :
		r"""fileuploadtype that can be bound to appfwprofile.
		"""
		try :
			return self._appfwprofile_fileuploadtype_binding
		except Exception as e:
			raise e
	...
	@property
	def appfwprofile_jsondosurl_bindings(self) :
		r"""jsondosurl that can be bound to appfwprofile.
		"""
		try :
			return self._appfwprofile_jsondosurl_binding
		except Exception as e:
			raise e
	...
	@property
	def appfwprofile_jsonsqlurl_bindings(self) :
		r"""jsonsqlurl that can be bound to appfwprofile.
		"""
		try :
			return self._appfwprofile_jsonsqlurl_binding
		except Exception as e:
			raise e
