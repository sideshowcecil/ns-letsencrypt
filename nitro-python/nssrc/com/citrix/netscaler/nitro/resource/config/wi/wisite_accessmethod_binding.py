...
class wisite_accessmethod_binding(base_resource) :
	...
	def filter_add_parameters(cls, resource) :
		...
		"""
		addresource = wisite_accessmethod_binding()
		addresource.sitepath = resource.sitepath
		addresource.accessmethod = resource.accessmethod
		addresource.clientipaddress = resource.clientipaddress
		addresource.clientnetmask = resource.clientnetmask
		return addresource
