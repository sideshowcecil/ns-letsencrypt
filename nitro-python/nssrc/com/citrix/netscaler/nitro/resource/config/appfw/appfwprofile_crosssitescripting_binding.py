...
class appfwprofile_crosssitescripting_binding(base_resource) :
	...
	def filter_add_parameters(cls, resource) :
		...
		"""
		addresource = appfwprofile_crosssitescripting_binding()
		addresource.name = resource.name
		addresource.crosssitescripting = resource.crosssitescripting
		addresource.formactionurl_xss = resource.formactionurl_xss
		addresource.isregex_xss = resource.isregex_xss
		addresource.as_scan_location_xss = resource.as_scan_location_xss
		addresource.as_value_type_xss = resource.as_value_type_xss
		addresource.as_value_expr_xss = resource.as_value_expr_xss
		addresource.isvalueregex_xss = resource.isvalueregex_xss
