...
class appfwprofile(base_resource) :
	...
	def postbodylimitsignature(self) :
		r"""Maximum allowed HTTP post body size for signature inspection for location HTTP_POST_BODY in the signatures, in bytes.<br/>Default value: 8192.
		"""
		try :
	...
	@property
	def autodeployrule(self) :
		r"""Auto deploy learned rule after configured time is elapsed.<br/>Default value: OFF.
		"""
		try :
			return self._autodeployrule
		except Exception as e:
			raise e
