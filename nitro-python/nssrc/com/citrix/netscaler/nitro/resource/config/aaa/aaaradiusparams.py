...
class aaaradiusparams(base_resource) :
	...
	def passencoding(self) :
		r"""Enable password encoding in RADIUS packets that the Citrix ADC sends to the RADIUS server.<br/>Default value: mschapv2<br/>Possible values = pap, chap, mschapv1, mschapv2.
		"""
		try :
