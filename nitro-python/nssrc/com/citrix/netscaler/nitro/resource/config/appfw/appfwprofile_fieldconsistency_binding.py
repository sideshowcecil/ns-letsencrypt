...
class appfwprofile_fieldconsistency_binding(base_resource) :
	...
	def filter_add_parameters(cls, resource) :
		...
		"""
		addresource = appfwprofile_fieldconsistency_binding()
		addresource.name = resource.name
		addresource.fieldconsistency = resource.fieldconsistency
		addresource.formactionurl_ffc = resource.formactionurl_ffc
		addresource.isregex_ffc = resource.isregex_ffc
