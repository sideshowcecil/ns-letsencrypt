...
class appfwprofile_safeobject_binding(base_resource) :
	...
	def filter_add_parameters(cls, resource) :
		...
		"""
		addresource = appfwprofile_safeobject_binding()
		addresource.name = resource.name
		addresource.safeobject = resource.safeobject
		addresource.as_expression = resource.as_expression
		addresource.maxmatchlength = resource.maxmatchlength
