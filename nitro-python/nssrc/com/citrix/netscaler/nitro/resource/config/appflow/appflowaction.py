...
class appflowaction(base_resource) :
	...
	@property
	def botinsight(self) :
		r"""On enabling this option, the Citrix ADC will send the bot insight records to the configured collectors.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._botinsight
		except Exception as e:
			raise e

	@botinsight.setter
	def botinsight(self, botinsight) :
		r"""On enabling this option, the Citrix ADC will send the bot insight records to the configured collectors.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED
		"""
		try :
			self._botinsight = botinsight
		except Exception as e:
			raise e
	...
	def filter_add_parameters(cls, resource) :
		...
		addresource.botinsight = resource.botinsight
	...
	def filter_update_parameters(cls, resource) :
		...
		updateresource.botinsight = resource.botinsight
