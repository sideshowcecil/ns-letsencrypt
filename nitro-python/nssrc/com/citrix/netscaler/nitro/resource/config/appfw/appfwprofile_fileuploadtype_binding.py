...
class appfwprofile_fileuploadtype_binding(base_resource) :
	""" Binding class showing the fileuploadtype that can be bound to appfwprofile.
	"""
	def __init__(self) :
		self._fileuploadtype = None
		self._as_fileuploadtypes_url = None
		self._state = None
		self._comment = None
		self._filetype = None
		self._isautodeployed = None
		self._name = None
		self._isregex_fileuploadtypes_url = None
		self.___count = None
	...
	@property
	def as_fileuploadtypes_url(self) :
		r"""FileUploadTypes action URL.
		"""
		try :
			return self._as_fileuploadtypes_url
		except Exception as e:
			raise e

	@as_fileuploadtypes_url.setter
	def as_fileuploadtypes_url(self, as_fileuploadtypes_url) :
		r"""FileUploadTypes action URL.
		"""
		try :
			self._as_fileuploadtypes_url = as_fileuploadtypes_url
		except Exception as e:
			raise e
	...
	@property
	def filetype(self) :
		r"""FileUploadTypes file types.<br/>Possible values = pdf, msdoc, text, image, any.
		"""
		try :
	...
	def fileuploadtype(self) :
		r"""FileUploadTypes to allow/deny.
		"""
		try :
	...
	@property
	def isregex_fileuploadtypes_url(self) :
		r"""Is a regular expression?.
		"""
		try :
			return self._isregex_fileuploadtypes_url
		except Exception as e:
			raise e

	@isregex_fileuploadtypes_url.setter
	def isregex_fileuploadtypes_url(self, isregex_fileuploadtypes_url) :
		r"""Is a regular expression?
		"""
		try :
			self._isregex_fileuploadtypes_url = isregex_fileuploadtypes_url
		except Exception as e:
			raise e
	...
	def _get_nitro_response(self, service, response) :
		...
		"""
		try :
			result = service.payload_formatter.string_to_resource(appfwprofile_fileuploadtype_binding_response, response, self.__class__.__name__)
			if(result.errorcode != 0) :
				...
				if result.severity :
					...
					raise nitro_exception(result.errorcode, str(result.message), str(result.severity))
			return result.appfwprofile_fileuploadtype_binding
		except Exception as e :
			raise e
	...
	def filter_add_parameters(cls, resource) :
		...
		"""
		addresource = appfwprofile_fileuploadtype_binding()
		addresource.name = resource.name
		addresource.comment = resource.comment
		addresource.state = resource.state
		addresource.fileuploadtype = resource.fileuploadtype
		addresource.as_fileuploadtypes_url = resource.as_fileuploadtypes_url
		addresource.isregex_fileuploadtypes_url = resource.isregex_fileuploadtypes_url
		addresource.filetype = resource.filetype
		...
		try :
			if resource and type(resource) is not list :
				...
				if resource and len(resource) > 0 :
					updateresources = [appfwprofile_fileuploadtype_binding() for _ in range(len(resource))]
	...
	def filter_delete_parameters(cls, resource) :
		...
		"""
		deleteresource = appfwprofile_fileuploadtype_binding()
		deleteresource.name = resource.name
		deleteresource.fileuploadtype = resource.fileuploadtype
		deleteresource.as_fileuploadtypes_url = resource.as_fileuploadtypes_url
		deleteresource.filetype = resource.filetype
	...
	def delete(cls, client, resource) :
		try :
			if resource and type(resource) is not list :
				...
				if resource and len(resource) > 0 :
					deleteresources = [appfwprofile_fileuploadtype_binding() for _ in range(len(resource))]
					for i in range(len(resource)) :
	...
	def get(cls, service, name="", option_="") :
		r""" Use this API to fetch appfwprofile_fileuploadtype_binding resources.
		"""
		try :
			if not name :
				obj = appfwprofile_fileuploadtype_binding()
	...
	def get_filtered(cls, service, name, filter_) :
		r""" Use this API to fetch filtered set of appfwprofile_fileuploadtype_binding resources.
	...
	def count(cls, service, name) :
		r""" Use this API to count appfwprofile_fileuploadtype_binding resources configued on NetScaler.
		"""
		try :
			obj = appfwprofile_fileuploadtype_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		r""" Use this API to count the filtered set of appfwprofile_fileuploadtype_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = appfwprofile_fileuploadtype_binding()
...
class appfwprofile_fileuploadtype_binding_response(base_response) :
	def __init__(self, length=1) :
		self.appfwprofile_fileuploadtype_binding = []
		self.errorcode = 0
		self.message = ""
		self.severity = ""
		self.sessionid = ""
		self.appfwprofile_fileuploadtype_binding = [appfwprofile_fileuploadtype_binding() for _ in range(length)]
