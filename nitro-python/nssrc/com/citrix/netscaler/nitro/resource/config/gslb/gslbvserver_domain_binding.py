...
class gslbvserver_domain_binding(base_resource) :
	...
	def filter_add_parameters(cls, resource) :
		...
		"""
		addresource = gslbvserver_domain_binding()
		addresource.name = resource.name
		addresource.domainname = resource.domainname
		addresource.ttl = resource.ttl
		addresource.backupip = resource.backupip
		addresource.cookie_domain = resource.cookie_domain
		addresource.cookietimeout = resource.cookietimeout
		addresource.sitedomainttl = resource.sitedomainttl
		return addresource
